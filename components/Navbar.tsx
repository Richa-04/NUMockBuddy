              ...
              {dropdownOpen && (
                <div style={{
                  ...
                  <div style={{ padding: '8px 0' }}>
                    {[
                      { label: 'Your Records', href: '/dashboard', icon: '📄' },
                     
                    ].map(item => (
                      <Link key={item.href} href={item.href}
                        onClick={() => setDropdownOpen(false)}
                        style={{ display: 'flex', alignItems: 'center', gap: 10, padding: '10px 20px', fontSize: 14, color: '#333', textDecoration: 'none', transition: 'background 0.1s' }}
